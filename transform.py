...
def main():
    ...
    """
    base_dir = "/capstor/store/cscs/swissai/a03/datasets/ego2d/"  # "/path/to/dataset"
    data_dir = "/capstor/store/cscs/swissai/a03/datasets/ego2d/processed/"
        ...
        with tqdm(total=len(futures), desc="Processing files") as pbar:
            for fut in as_completed(futures):
                try:
                    ...
                    # Handle exceptions if any future fails
