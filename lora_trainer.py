...
class CogVideoXI2VLoraTrainer(Trainer):
    ...
    def load_components(self) -> Dict[str, Any]:
        ...
        # components.action_encoder = ActionEncoder.from_pretrained(model_path, subfolder="action_encoder")
    ...
    def encode_action(self, action: torch.Tensor) -> torch.Tensor:
        action_encoder = self.components.action_encoder
        action = action.to(action_encoder.device, dtype=action_encoder.dtype)
